...
الفكرة الأساسية من الذكاء الاصطناعي إنك **تعطيه المهمة وتروح ترتاح**، وتصحى الصباح وتلقى الشغل جاهز ومختبر؛ مو إن الوكيل يصحّيك كل دقيقة ويسألك: *"أشغّل هذا الأمر؟"*، *"توافق على الفحص؟"*. هذا يضيّع وقتك ويبطل فايدة الأتمتة!

الأخطاء الشائعة للوكلاء بدون هذي المهارة:
1. **التعديل المتهوّر بدون استكشاف:** يدخل على ملفات عشوائية ويعدل عليها بدون ما يدري وش البنية أو التبعيات المستخدمة.
2. **الأسئلة البديهية اللي ترفع الضغط:** *"وين الكود؟"*, *"وين ملف الإعدادات؟"*, *"وش المفروض أسوي؟"* مع إن الأجوبة كلها موجودة في المشروع!
3. **نوافذ التأكيد المزعجة (Permission Popups):** عشان يفحص منفذ (Port) أو حاوية دوكر، يرسل أوامر خارج النطاق ويقفل النظام ينتظر موافقتك.
4. **مسح وتخريب التعديلات الحالية (Uncommitted Changes):** يتجاهل التعديلات اللي شغال عليها المطور ويكتب فوقها بدون ما ينتبه.
5. **إعادة اختراع العجلة:** يتجاهل الدوال والمكتبات الجاهزة في المشروع ويبدأ يكتب كود جديد مكرر من الصفر.
